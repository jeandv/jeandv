...
- 🚀 &nbsp; Exploring Electronic with Arduino and C++, DevOps (AWS, Docker, Kubernetes, etc), React Native, Three.js
...
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,nextjs,tailwind,graphql)](https://jeanrondon.is-a.dev)
